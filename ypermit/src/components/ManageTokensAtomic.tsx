...
export function ManageTokensAtomic({ tokens, selected_token, set_selected, busy, set_busy }: ManageTokensAtomicProps) {
  ...
  return (
    <>
      ...
      {selected_here && selected_token && (
        <>
          {is_depositable && <MakeDepositAtomic token={selected_token} busy={busy} set_busy={set_busy} />}
